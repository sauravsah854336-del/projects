...
export const authApi = createApi({
  ...
  tagTypes: [
    "Vendors", "Categories", "Products", "VendorProducts", "AdminProducts",
    "Cart", "Orders", "AdminOrders", "VendorOrders",
    "Reviews", "CanReview", "MyReviews", "AdminReviews", "VendorReviews",
    "Profile", "Wishlist",
    "AdminStats", "Admins", "Customers",
  ],
  endpoints: (builder) => ({
    ...
    createAdmin: builder.mutation({
      query: (data) => ({ url: "/admin/createAdmin", method: "POST", body: data }),
    ...
    approveVendor: builder.mutation({
      query: (vendorId) => ({ url: `/admin/vendors/${vendorId}/approve`, method: "PUT" }),
    ...
    unsuspendVendor: builder.mutation({
      query: (vendorId) => ({ url: `/admin/vendors/${vendorId}/unsuspend`, method: "PUT" }),
      invalidatesTags: ["Vendors", "AdminStats"],
    }),
    ...
    blockCustomer: builder.mutation({
      query: (userId) => ({ url: `/admin/customers/${userId}/block`, method: "PUT" }),
      invalidatesTags: ["Customers", "AdminStats"],
    }),
    unblockCustomer: builder.mutation({
      query: (userId) => ({ url: `/admin/customers/${userId}/unblock`, method: "PUT" }),
      invalidatesTags: ["Customers", "AdminStats"],
    }),
    deleteCustomer: builder.mutation({
      query: (userId) => ({ url: `/admin/customers/${userId}`, method: "DELETE" }),
      invalidatesTags: ["Customers", "AdminStats"],
    }),
  }),
});
