    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-[1000px] grid lg:grid-cols-2 bg-white rounded-3xl shadow-2xl shadow-black/5 overflow-hidden border border-gray-100">
        <div className="hidden lg:flex flex-col justify-center items-center bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] p-12 relative overflow-hidden">
          <div className="absolute top-10 right-10 w-48 h-48 bg-[#D85A30]/20 rounded-full blur-3xl"></div>
          ...
          {step === 1 && (
            <div className="space-y-5">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-[#D85A30] to-[#e8734d] text-white py-4 rounded-xl font-semibold shadow-lg shadow-[#D85A30]/20 hover:shadow-[#D85A30]/40 hover:scale-[1.01] transition-all duration-200 text-[15px]"
              >
                Continue →
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={form.phone}
                    onChange={handleChange}
                    className="w-full border border-gray-200 pl-[4.5rem] pr-4 py-3.5 rounded-xl outline-none focus:border-[#D85A30] focus:ring-4 focus:ring-[#D85A30]/10 transition-all text-[15px] bg-gray-50 focus:bg-white"
                    maxLength={10}
                  />
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="flex-[2] bg-gradient-to-r from-[#D85A30] to-[#e8734d] text-white py-4 rounded-xl font-semibold shadow-lg shadow-[#D85A30]/20 hover:shadow-[#D85A30]/40 hover:scale-[1.01] transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100 text-[15px]"
                >
                  {isLoading ? (
