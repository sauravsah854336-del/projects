          ...
          {redirectPath === "/checkout" && (
            <div className="mb-5 bg-blue-50 border border-blue-200 rounded-xl p-3 flex items-center gap-2">
              ...
              <p className="text-xs text-blue-700 font-medium">
                Sign in to complete your checkout. Your cart items are saved.
              </p>
            </div>
          )}

          {redirectPath === "/wishlist" && (
            <div className="mb-5 bg-pink-50 border border-pink-200 rounded-xl p-3 flex items-center gap-2">
